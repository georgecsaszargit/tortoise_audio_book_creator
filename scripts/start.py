...
if __name__ == "__main__":
    ...
    for voice_idx, (voice, voice_samples, conditioning_latents) in enumerate(
        ...
        for text_idx, text in enumerate(texts):
            ...
            if args.output.output_dir:
                ...
                if (
                    ...
                    audio_parts.append(load_audio(first_clip, 48000))
                    if verbose:
        ...
        audio_parts = [part.squeeze().numpy() for part in audio_parts] 
        audio = sf.concatenate(audio_parts, samplerate=48000)
        if args.output.output_dir:
            ...
            #torchaudio.save(f.name, audio, 48000)
            audio = torch.from_numpy(audio)
            torchaudio.save(filename, audio, samplerate=48000)
